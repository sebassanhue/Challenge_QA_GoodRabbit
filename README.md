...
## 📸 Evidencia de Automatización UI (Playwright)

A continuación se muestra el reporte de ejecución exitosa en Chromium, evidenciando el manejo de tiempos de espera adaptados ante la latencia del servidor:

![Reporte de Playwright Exitoso](documentacion/playwright-report.png)
